...
const GUIDED_PLAYBOOK=Object.freeze([
  ...
  {id:"02",title:"Variation axes",summary:"Multiply a proven concept along controlled axes before replacing it with unrelated ideas.",
    ...
    operator:"Change one declared variable at a time when the goal is learning, and let sibling variants collect separate evidence. Build full size coverage when the buying lane requires it.",
    ...
    checklist:["Declare the changed axis.","Hold comparison variables steady.","Name each version consistently.","Do not call a cosmetic change a new concept."],terms:["axis","multiplication","a/b ad permutation","geo cut","creative test"]},
  ...
  {id:"05",title:"Hierarchy, navigation, and diagnostic order",summary:"Know which object is being observed or changed: account, campaign, group, ad, creative, keyword diagnostic, or measurement source.",
    ...
    operator:"Widen thin date windows, preserve reporting configuration, and trace the relevant evidence path with its declared denominator before editing live delivery. Inspect the weak Quality Score component before deciding whether copy, the destination, or another control should change; a larger bid does not improve the score.",
    advanced:"Quality Score is neither a KPI nor the literal auction-time input. A reporting key, attribution label, optimization source, and diagnostic score may overlap operationally, but they are not the same object.",
    checklist:["Name the object and scope.","Use a sufficient date window.","Inspect the three Quality Score components.","Record the current configuration."],terms:["ad","creative","campaign","pixel","quality score","expected ctr","ad relevance","landing page experience"]},
  ...
  {id:"08",title:"Questions for the account lead",summary:"Turn unknown account context and client preferences into explicit, testable questions instead of unsupported conclusions.",
    core:"Ask what the campaign is for, which baseline and source of truth govern it, what constraints apply, and who owns the next decision. Treat the business context as a starting hypothesis, never a personality verdict.",
    ...
    advanced:"Questions should discriminate among account and relationship hypotheses. Track results confidence, judgment, transparency, responsiveness, and alignment separately from short-term tension. Evidence and operational quality outrank stylistic fit; later behavior must verify each commitment.",
    checklist:["Prioritize three decision-changing questions.","Label the business prior as uncertain.","Separate facts from observable cues.","Record the reaction and update the Client Read.","Name the owner, evidence check, and due point.","Close or renegotiate every commitment."],terms:["intake","baseline","business prior","client trust","trust dimensions","client tension","communication stance","client insight","client read","working agreement","commitment","relationship risk"]},
